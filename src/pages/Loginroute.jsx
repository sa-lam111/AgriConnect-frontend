...
export default function Loginroute() {
  return (
    <div className='flex justify-center items-center h-screen bg-gray-200'>
      ...
      <div className='flex space-x-5 py-10 pb-15'>
      <div className='text-[20px] font-semibold py-10 px-5 rounded-lg bg-green-600 hover:bg-green-400 text-white hover:scale-110 transition-all duration-400 cursor-pointer'>
        <Link to="/login">Login as a user</Link>
      </div>
       <div className='text-[20px] font-semibold py-10 px-5 rounded-lg bg-green-600 hover:bg-green-400 text-white hover:scale-110 transition-all duration-400 cursor-pointer'>
        <Link to="/farmerlogin">Login as a farmer</Link>
      </div>
      </div>
